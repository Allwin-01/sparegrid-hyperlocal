...
// Mock Link for Vite environment
...
export function SignInCard({ onLoginSuccess }: { onLoginSuccess?: () => void }) {
  ...
  const rotateX = useTransform(mouseY, [-300, 300], isMobile ? [0, 0] : [10, -10]);
  const rotateY = useTransform(mouseX, [-300, 300], isMobile ? [0, 0] : [-10, 10]);
